...
export default function Solutions() {
  return (
    <>
      ...
      <section className="bg-paper-100 py-16 sm:py-20" aria-label="Les sept pôles">
      ...
      <Section3D variant="up" className="bg-white">
        <section className="bg-white py-20 sm:py-24" aria-labelledby="regimes-heading">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <SectionHeading
            ...
            <Stagger className="mt-12 grid grid-cols-1 gap-5 lg:grid-cols-3" stagger={0.1}>
              {REGIMES.map(({ icon: Icon, name, brand, forWho, points }) => (
                <RevealItem key={name} variant="up" className="flex h-full flex-col rounded-2xl border border-ink-900/8 bg-paper-100 p-7">
